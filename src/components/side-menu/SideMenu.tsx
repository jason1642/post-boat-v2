...
import {Container, Title, Item, LinkButton, FollowButton} from '../../styles/account-page/side-menu.js'
import moment from 'moment'
import Button from '@mui/material/Button';
import { followUser } from '../api-helpers/user-api.ts'
...
const SideMenu: React.FunctionComponent<ISideMenuProps> = ({paramsUserData, onPostPage, currentUser }) => {
  ...
  return (
    <Container>
      ...
      <Item onClick={()=>setFollowerList(true)}>Followers: {followersNum}</Item>
      <Item onClick={()=> setFollowingList(true)}>Following: {paramsUserData.following.length}</Item>
